        ...
        RouterModule.forRoot([
            { path: '', redirectTo: 'auth/login', pathMatch: 'full'},
            {
                ...
                children: [
                    ...
                    { path: 'administracion', loadChildren: () => import('./components/administracion/administracion.module').then(m => m.AdministracionModule), canActivate: [AuthGuard], data: { expectedRole: ['admin'] }},
                    { path: 'operar-ofertas', loadChildren: () => import('./components/operar-ofertas/operar-ofertas.module').then(m => m.OperarOfertasModule), canActivate: [AuthGuard]},
